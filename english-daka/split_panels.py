...
PANELS = {
    ...
    # 一整幅房间场景:蝙蝠在左上、帽子挂右墙、猫坐在地毯上。原来三问共用整幅图,
    # 问哪一个都对不准,而且 word 写成 "cat bat hat" 这种页面标题,考一考问不出题。
    # 帽子那格比 3:4 瘦,cut() 会左右补背景色 —— 这张的底色是均匀的黄条纹墙纸,补得出来。
    "wf-at-2":        [("cat", (0.14, 0.33, 0.80, 0.95), 0),
                       ("bat", (0.03, 0.01, 0.67, 0.32), 1),
                       ("hat", (0.63, 0.115, 0.99, 0.60), 2)],
