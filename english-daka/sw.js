/* ================================================================
   ...
   activate 会把旧版整个删掉。
   ================================================================ */
const CACHE = "daka-v20";   // v20:标错题的图标书本改小旗(插旗=标记要练);v19:学一学卡头手动进/出错题本;v18:帽子行三入口统一粉彩(继续学也改淡绿,不再实心);v17:目录页次按钮上淡彩(混合复习淡蓝/错题本淡橙);v16:考一考并入复习账本(P3);v15:错题本(账本切片专练)+ 记账一天一笔;v9:目录页标题收进帽子与打卡条同排 + 打卡日历弹窗(周记录改周一起点);v7:目录页帽子收进同列卡(v6:课程页顶栏/气泡/标签减重;v5:目录页改横滚货架;v4:UI 素材入库 + 混合复习 Leitner 版;main 侧曾占用 v3)
